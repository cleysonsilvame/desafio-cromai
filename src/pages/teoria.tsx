    ...
    <Container className={styles.container}>
      ...
      <CardCenter icon={FaHistory} title="Teoria">
        <Row className={`m-4 p-3 bg-light text-justify ${styles.innerCard}`}>
          ...
          <p>
            Num triângulo retângulo, sempre que souber o comprimento de dois dos
            seus lados, torna-se relativamente fácil descobrir o comprimento do
            terceiro lado que falta. Para descobrir isso basta utilizar a
            seguinte fórmula designada por Teorema de Pitágoras:{' '}
            <code>a² = b² + c²</code>
          </p>
          <p>
          ...
          <p>
            A nossa calculadora irá mostrar os cálculos necessários para obter o
            resultado.
          </p>
        </Row>
